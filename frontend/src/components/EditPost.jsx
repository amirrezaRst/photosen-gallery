...
const EditPost = () => {
    ...
    useEffect(() => {
        setTitleField(params.state.pictureData.subtitle);
        setImageField({ name: params.state.pictureData.picAddress });
        setCategoryField(params.state.pictureData.category)
    }, [params.state.pictureData])
    ...
    const editPostApi = async () => {
        ...
        await axios.put(`${config.localDomain}/api/user/editPicture/${params.state.postId}`, formData).then(res => {
            const findPictureIndex = context.pictures.findIndex(item => {
                return item._id == params.state.postId
            })
            context.pictures[findPictureIndex] = res.data.picture;

            Swal.fire({
                title: 'Post Edited',
                text: "The post was Edited successfully, click the button below to see it.",
                icon: 'success',
            ...
            Swal.fire({
                ...
                text: "You had a problem editing the post, please try again later",
                icon: "error"
            })
            console.log(err);
        })
    ...
    const result = () => {
        ...
        // console.log(context.pictures[6]);
    }
    ...
    return (
        <main class="site-section" data-aos="fade">
            <div class="container">
                ...
                <Helmet>
                    <title>Photosen - Edit Post</title>
                </Helmet>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-7">
                        <div class="row mb-2">
                            <div class="col-12 ">
                                <h2 class="site-section-heading text-center">Edit Post</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 mb-5 mx-auto">
                    <form onSubmit={e => e.preventDefault()}>
                        ...
                        <div class="row form-group mt-5">
                            <div class="col-md-12">
                                <button class="btn btn-primary py-2 px-4 text-black" onClick={editPostApi}>Edit Post</button>
                            </div>
                        </div>
